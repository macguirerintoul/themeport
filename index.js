...
let scheme = {
  base: { // Colours that are generally used across several applications
...
if (from === "vscode") {
  ...
  */
  ...
  scheme.base.boolean = tokenColors["constant.language.boolean"].settings.foreground // Colour of true/false
...
function formatScheme(scheme, to) {
  ...
  if (to === "vim") {
    ...
    formattedScheme.colors.CursorLine = generateVimColorSet(null, scheme.base.cursorLine)
  }
